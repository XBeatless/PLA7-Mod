...
{ 
	...
	SDK_UNDEFINED(80,2783) /* TMap<uint32_t, FPointWeightMap> */ __um(WeightMaps);                                 // 0x0030   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,2784) /* TMap<FName, UClothConfigBase*> */ __um(ClothConfigs);                                // 0x0050   (0x0050)  
	class UClothConfigBase*                            ClothSharedSimConfig;                                       // 0x00A0   (0x0008)  
	class UClothConfigBase*                            ClothSimConfig;                                             // 0x00A8   (0x0008)  
	class UClothConfigBase*                            ChaosClothSimConfig;                                        // 0x00B0   (0x0008)  
	TArray<class UClothLODDataCommon_Legacy*>          ClothLODData;                                               // 0x00B8   (0x0010)  
	...
	class UClothingAssetCustomData*                    CustomData;                                                 // 0x0110   (0x0008)  
...
public:
	...
	unsigned char                                      UnknownData01_6[0x20];                                      // 0x0168   (0x0020)  MISSED
};
