...
{ 
	...
	SDK_UNDEFINED(80,2799) /* TMap<FName, int32_t> */  __um(NameToIndexMapping);                                   // 0x0018   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(80,2800) /* TMap<FName, int32_t> */  __um(NameToIndexMapping);                                   // 0x0018   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(80,2801) /* TMap<FName, int32_t> */  __um(NameToIndexMapping);                                   // 0x0018   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(80,2802) /* TMap<FName, int32_t> */  __um(NameToIndexMapping);                                   // 0x0018   (0x0050)  
	unsigned char                                      UnknownData00_6[0x8];                                       // 0x0068   (0x0008)  MISSED
};
...
{ 
	...
	SDK_UNDEFINED(1,2803) /* TEnumAsByte<EControlRigDrawSettings> */ __um(PrimitiveType);                          // 0x0008   (0x0001)  
...
{ 
public:
	unsigned char                                      UnknownData00_3[0x74];                                      // 0x0000   (0x0074)  MISSED
	ERigExecutionType                                  ExecutionType;                                              // 0x0074   (0x0001)  
	unsigned char                                      UnknownData01_5[0x3];                                       // 0x0075   (0x0003)  MISSED
	class URigVM*                                      VM;                                                         // 0x0078   (0x0008)  
	FRigHierarchyContainer                             Hierarchy;                                                  // 0x0080   (0x01B0)  
	SDK_UNDEFINED(40,2804) /* TWeakObjectPtr<UControlRigGizmoLibrary*> */ __um(GizmoLibrary);                      // 0x0230   (0x0028)  
	unsigned char                                      UnknownData02_5[0x10];                                      // 0x0258   (0x0010)  MISSED
	SDK_UNDEFINED(80,2805) /* TMap<FName, FCachedPropertyPath> */ __um(InputProperties);                           // 0x0268   (0x0050)  
	SDK_UNDEFINED(80,2806) /* TMap<FName, FCachedPropertyPath> */ __um(OutputProperties);                          // 0x02B8   (0x0050)  
	FControlRigDrawContainer                           DrawContainer;                                              // 0x0308   (0x0010)  
	unsigned char                                      UnknownData03_5[0x8];                                       // 0x0318   (0x0008)  MISSED
	class UAnimationDataSourceRegistry*                DataSourceRegistry;                                         // 0x0320   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(16,2807) /* FMulticastInlineDelegate */ __um(OnPreInitializeDelegate);                           // 0x00B0   (0x0010)  
	SDK_UNDEFINED(16,2808) /* FMulticastInlineDelegate */ __um(OnPostInitializeDelegate);                          // 0x00C0   (0x0010)  
	SDK_UNDEFINED(16,2809) /* FMulticastInlineDelegate */ __um(OnPreEvaluateDelegate);                             // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,2810) /* FMulticastInlineDelegate */ __um(OnPostEvaluateDelegate);                            // 0x00E0   (0x0010)  
	class UControlRig*                                 ControlRig;                                                 // 0x00F0   (0x0008)  


	/// Functions
	// Function /Script/ControlRig.ControlRigComponent.OnPreInitialize
	// void OnPreInitialize();                                                                                               // [0x718be0] Native|Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigComponent.OnPreEvaluate
	// void OnPreEvaluate();                                                                                                 // [0x718bc0] Native|Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigComponent.OnPostInitialize
	// void OnPostInitialize();                                                                                              // [0x68b8c0] Native|Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigComponent.OnPostEvaluate
	// void OnPostEvaluate();                                                                                                // [0x718ba0] Native|Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigComponent.BP_GetControlRig
	// class UControlRig* BP_GetControlRig();                                                                                // [0x718b70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
	...
	SDK_UNDEFINED(40,2811) /* TWeakObjectPtr<UStaticMesh*> */ __um(StaticMesh);                                    // 0x0008   (0x0028)  
...
public:
	...
	SDK_UNDEFINED(40,2812) /* TWeakObjectPtr<UMaterial*> */ __um(DefaultMaterial);                                 // 0x0090   (0x0028)  
...
{ 
public:
	SDK_UNDEFINED(40,2813) /* TWeakObjectPtr<UAnimSequence*> */ __um(LastExportedToAnimationSequence);             // 0x0498   (0x0028)  
	SDK_UNDEFINED(40,2814) /* TWeakObjectPtr<USkeletalMesh*> */ __um(LastExportedUsingSkeletalMesh);               // 0x04C0   (0x0028)  
...
{ 
public:
	class UControlRig*                                 ControlRig;                                                 // 0x0140   (0x0008)  
	...
	SDK_UNDEFINED(80,2815) /* TMap<FName, FChannelMapInfo> */ __um(ControlChannelMap);                             // 0x0210   (0x0050)  
...
{ 
public:
	class UControlRig*                                 ControlRig;                                                 // 0x0058   (0x0008)  
	class UMovieSceneSection*                          SectionToKey;                                               // 0x0060   (0x0008)  
	TArray<class UMovieSceneSection*>                  Sections;                                                   // 0x0068   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(80,2816) /* TMap<FName, uint16_t> */ __um(ControlRigBoneMapping);                                // 0x0068   (0x0050)  
	SDK_UNDEFINED(80,2817) /* TMap<FName, uint16_t> */ __um(ControlRigCurveMapping);                               // 0x00B8   (0x0050)  
	SDK_UNDEFINED(80,2818) /* TMap<FName, uint16_t> */ __um(InputToCurveMappingUIDs);                              // 0x0108   (0x0050)  
	SDK_UNDEFINED(8,2819) /* TWeakObjectPtr<UNodeMappingContainer*> */ __um(NodeMappingContainer);                 // 0x0158   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(80,2820) /* TMap<FName, FName> */    __um(InputMapping);                                         // 0x0210   (0x0050)  
	SDK_UNDEFINED(80,2821) /* TMap<FName, FName> */    __um(OutputMapping);                                        // 0x0260   (0x0050)  
...
{ 
	SDK_UNDEFINED(8,2822) /* TWeakObjectPtr<UControlRig*> */ __um(ControlRig);                                     // 0x0170   (0x0008)  
};
...
{ 
	class UControlRig*                                 AnimControlRig;                                             // 0x0058   (0x0008)  
};
...
{ 
	...
	SDK_UNDEFINED(16,2823) /* TArray<FString> */       __um(Contents);                                             // 0x0010   (0x0010)  
...
{ 
	SDK_UNDEFINED(1,2824) /* TEnumAsByte<EControlRigDrawHierarchyMode> */ __um(Mode);                              // 0x0020   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x0021   (0x0003)  MISSED
...
{ 
	...
	SDK_UNDEFINED(1,2825) /* TEnumAsByte<EAxis> */     __um(Axis);                                                 // 0x0020   (0x0001)  
...
{ 
	unsigned char                                      UnknownData00_3[0x8];                                       // 0x0008   (0x0008)  MISSED
	FTransform                                         value;                                                      // 0x0010   (0x0030)  
	SDK_UNDEFINED(1,2826) /* TEnumAsByte<EAxis> */     __um(Axis);                                                 // 0x0040   (0x0001)  
	SDK_UNDEFINED(1,2827) /* TEnumAsByte<EControlRigClampSpatialMode> */ __um(Type);                               // 0x0041   (0x0001)  
...
{ 
	FVector                                            value;                                                      // 0x0008   (0x000C)  
	SDK_UNDEFINED(1,2828) /* TEnumAsByte<EAxis> */     __um(Axis);                                                 // 0x0014   (0x0001)  
	SDK_UNDEFINED(1,2829) /* TEnumAsByte<EControlRigClampSpatialMode> */ __um(Type);                               // 0x0015   (0x0001)  
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0024   (0x0004)  MISSED
	SDK_UNDEFINED(16,2830) /* FString */               __um(Prefix);                                               // 0x0028   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(80,2831) /* TMap<int32_t, int32_t> */ __um(ConstraintDataToTargets);                             // 0x0010   (0x0050)  
};
