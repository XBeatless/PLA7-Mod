...
public:
	...
	// void ExecuteUbergraph(int32_t EntryPoint);                                                                            // [0x15dd8c0] Event|Public|BlueprintEvent 
};
#pragma pack(pop)
...
{ 
	...
	SDK_UNDEFINED(16,7) /* FString */                  __um(SubPathString);                                        // 0x0008   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,10) /* FString */                 __um(NativeCulture);                                        // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,11) /* FString */                 __um(Namespace);                                            // 0x0018   (0x0010)  
	SDK_UNDEFINED(16,12) /* FString */                 __um(Key);                                                  // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,13) /* FString */                 __um(NativeString);                                         // 0x0038   (0x0010)  
	SDK_UNDEFINED(80,14) /* TMap<FString, FString> */  __um(LocalizedStrings);                                     // 0x0048   (0x0050)  
	bool                                               bIsMinimalPatch;                                            // 0x0098   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0099   (0x0007)  MISSED
	SDK_UNDEFINED(24,15) /* FText */                   __um(CachedText);                                           // 0x00A0   (0x0018)  
};
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0001   (0x0007)  MISSED
	SDK_UNDEFINED(16,16) /* FString */                 __um(Message);                                              // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,17) /* FString */                 __um(Context);                                              // 0x0018   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,18) /* FString */                 __um(Filename);                                             // 0x0038   (0x0010)  
