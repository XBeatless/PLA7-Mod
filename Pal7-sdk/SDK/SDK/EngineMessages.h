...
{ 
	SDK_UNDEFINED(16,2892) /* FString */               __um(Text);                                                 // 0x0000   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2893) /* FString */               __um(UserName);                                             // 0x0000   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2894) /* FString */               __um(Command);                                              // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2895) /* FString */               __um(UserName);                                             // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2896) /* FString */               __um(UserName);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2897) /* FString */               __um(UserToGrant);                                          // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2898) /* FString */               __um(UserName);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2899) /* FString */               __um(UserToDeny);                                           // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2900) /* FString */               __um(CurrentLevel);                                         // 0x0000   (0x0010)  
	...
	SDK_UNDEFINED(16,2901) /* FString */               __um(InstanceType);                                         // 0x0028   (0x0010)  
