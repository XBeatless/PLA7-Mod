...
{ 
public:
	class UMediaSource*                                MediaSource;                                                // 0x00E0   (0x0008)  
...
public:
	...
	class UMediaTexture*                               MediaTexture;                                               // 0x00F0   (0x0008)  
	class UMediaSoundComponent*                        MediaSoundComponent;                                        // 0x00F8   (0x0008)  
	bool                                               bUseExternalMediaPlayer;                                    // 0x0100   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0101   (0x0007)  MISSED
	class UMediaPlayer*                                ExternalMediaPlayer;                                        // 0x0108   (0x0008)  
};
...
{ 
public:
	TArray<class UMovieSceneSection*>                  MediaSections;                                              // 0x0058   (0x0010)  
};
...
{ 
	class UMediaSource*                                MediaSource;                                                // 0x0048   (0x0008)  
