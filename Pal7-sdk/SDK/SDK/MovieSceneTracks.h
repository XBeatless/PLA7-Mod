...
{ 
public:
	class UMovieSceneSection*                          SectionToKey;                                               // 0x0058   (0x0008)  
	FName                                              PropertyName;                                               // 0x0060   (0x0008)  
	SDK_UNDEFINED(16,1144) /* FString */               __um(PropertyPath);                                         // 0x0068   (0x0010)  
...
public:
	...
	// FTransform BP_GetTransformOrigin();                                                                                   // [0x15dd8c0] Event|Protected|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	...
	// void SetConstraintBindingID(FMovieSceneObjectBindingID& InConstraintBindingID);                                       // [0x24a7fd0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieSceneTracks.MovieScene3DConstraintSection.GetConstraintBindingID
	// FMovieSceneObjectBindingID GetConstraintBindingID();                                                                  // [0x24a7f70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
public:
	TArray<class UMovieSceneSection*>                  ConstraintSections;                                         // 0x0058   (0x0010)  
};
...
public:
	...
	bool                                               bFollow : 1;                                                // 0x01AC:0 (0x0001)  
	bool                                               bReverse : 1;                                               // 0x01AC:1 (0x0001)  
	bool                                               bForceUpright : 1;                                          // 0x01AC:2 (0x0001)  
...
public:
	...
	SDK_UNDEFINED(16,1145) /* TArray<FString> */       __um(ActorGuidStrings);                                     // 0x0210   (0x0010)  
};
...
{ 
public:
	class USoundBase*                                  Sound;                                                      // 0x00E0   (0x0008)  
	...
	class USoundAttenuation*                           AttenuationSettings;                                        // 0x02F8   (0x0008)  
	SDK_UNDEFINED(16,1146) /* FDelegateProperty */     __um(OnQueueSubtitles);                                     // 0x0300   (0x0010)  
	SDK_UNDEFINED(16,1147) /* FMulticastInlineDelegate */ __um(OnAudioFinished);                                   // 0x0310   (0x0010)  
	SDK_UNDEFINED(16,1148) /* FMulticastInlineDelegate */ __um(OnAudioPlaybackPercent);                            // 0x0320   (0x0010)  


	/// Functions
	// Function /Script/MovieSceneTracks.MovieSceneAudioSection.SetStartOffset
	// void SetStartOffset(FFrameNumber InStartOffset);                                                                      // [0x24a8110] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/MovieSceneTracks.MovieSceneAudioSection.SetSound
	// void SetSound(class USoundBase* InSound);                                                                             // [0x24a8090] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieSceneTracks.MovieSceneAudioSection.GetStartOffset
	// FFrameNumber GetStartOffset();                                                                                        // [0x24a7fb0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieSceneTracks.MovieSceneAudioSection.GetSound
	// class USoundBase* GetSound();                                                                                         // [0xe9bd40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
public:
	TArray<class UMovieSceneSection*>                  AudioSections;                                              // 0x0058   (0x0010)  
};
...
{ 
public:
	class UEnum*                                       Enum;                                                       // 0x0088   (0x0008)  
};
...
public:
	...
	class UCameraAnim*                                 CameraAnim;                                                 // 0x0100   (0x0008)  
...
{ 
public:
	TArray<class UMovieSceneSection*>                  CameraAnimSections;                                         // 0x0058   (0x0010)  
};
...
public:
	...
	// void SetCameraBindingID(FMovieSceneObjectBindingID& InCameraBindingID);                                               // [0x24a7fd0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieSceneTracks.MovieSceneCameraCutSection.GetCameraBindingID
	// FMovieSceneObjectBindingID GetCameraBindingID();                                                                      // [0x24a7f70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	TArray<class UMovieSceneSection*>                  Sections;                                                   // 0x0060   (0x0010)  
};
...
{ 
	...
	ECameraAnimPlaySpace                               PlaySpace;                                                  // 0x000C   (0x0001)  
...
public:
	...
	class UClass*                                      ShakeClass;                                                 // 0x0100   (0x0008)  
...
{ 
public:
	TArray<class UMovieSceneSection*>                  CameraShakeSections;                                        // 0x0058   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(16,1149) /* FString */               __um(ShotDisplayName);                                      // 0x0158   (0x0010)  
	SDK_UNDEFINED(24,1150) /* FText */                 __um(DisplayName);                                          // 0x0168   (0x0018)  


	/// Functions
	// Function /Script/MovieSceneTracks.MovieSceneCinematicShotSection.SetShotDisplayName
	// void SetShotDisplayName(FString InShotDisplayName);                                                                   // [0x24ae1c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieSceneTracks.MovieSceneCinematicShotSection.GetShotDisplayName
	// FString GetShotDisplayName();                                                                                         // [0x24ae020] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
public:
	bool                                               bFireEventsWhenForwards : 1;                                // 0x0058:0 (0x0001)  
	bool                                               bFireEventsWhenBackwards : 1;                               // 0x0058:1 (0x0001)  
	...
	TArray<class UMovieSceneSection*>                  Sections;                                                   // 0x0070   (0x0010)  
};
...
public:
	...
	bool                                               bFadeAudio : 1;                                             // 0x0190:0 (0x0001)  
...
public:
	...
	// void SetVisibility(ELevelVisibility InVisibility);                                                                    // [0x24ae2b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieSceneTracks.MovieSceneLevelVisibilitySection.SetLevelNames
	// void SetLevelNames(TArray<FName>& InLevelNames);                                                                      // [0x24ae110] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieSceneTracks.MovieSceneLevelVisibilitySection.GetVisibility
	// ELevelVisibility GetVisibility();                                                                                     // [0x24ae0e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieSceneTracks.MovieSceneLevelVisibilitySection.GetLevelNames
	// TArray<FName> GetLevelNames();                                                                                        // [0x24adff0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
public:
	class UMaterialParameterCollection*                MPC;                                                        // 0x0068   (0x0008)  
};
...
{ 
public:
	class UClass*                                      PropertyClass;                                              // 0x0088   (0x0008)  
};
...
{ 
public:
	TArray<class UMovieSceneSection*>                  ParticleSections;                                           // 0x0058   (0x0010)  
};
...
public:
	...
	class UAnimSequence*                               AnimSequence;                                               // 0x01B8   (0x0008)  
	class UAnimSequenceBase*                           Animation;                                                  // 0x01C0   (0x0008)  
	float                                              StartOffset;                                                // 0x01C8   (0x0004)  
	float                                              EndOffset;                                                  // 0x01CC   (0x0004)  
	float                                              PlayRate;                                                   // 0x01D0   (0x0004)  
	bool                                               bReverse : 1;                                               // 0x01D4:0 (0x0001)  
	unsigned char                                      UnknownData00_4[0x3];                                       // 0x01D5   (0x0003)  MISSED
	FName                                              SlotName;                                                   // 0x01D8   (0x0008)  
	bool                                               bIsFaceFxAnimationSection;                                  // 0x01E0   (0x0001)  
	unsigned char                                      UnknownData01_5[0x3];                                       // 0x01E1   (0x0003)  MISSED
	int32_t                                            DialogueID;                                                 // 0x01E4   (0x0004)  
};
...
{ 
public:
	TArray<class UMovieSceneSection*>                  AnimationSections;                                          // 0x0058   (0x0010)  
	bool                                               bIsFaceFxAnimationTrack;                                    // 0x0068   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0069   (0x0007)  MISSED
	SDK_UNDEFINED(16,1151) /* FString */               __um(FaceFxTrackName);                                      // 0x0070   (0x0010)  
	bool                                               bUseLegacySectionIndexBlend;                                // 0x0080   (0x0001)  
...
{ 
	TArray<FFrameNumber>                               Times;                                                      // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,1152) /* TArray<FString> */       __um(Values);                                               // 0x0018   (0x0010)  
	SDK_UNDEFINED(16,1153) /* FString */               __um(DefaultValue);                                         // 0x0028   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,1154) /* FString */               __um(value);                                                // 0x0000   (0x0010)  
};
...
{ 
	...
	bool                                               bFireEventsWhenForwards : 1;                                // 0x0030:0 (0x0001)  
	bool                                               bFireEventsWhenBackwards : 1;                               // 0x0030:1 (0x0001)  
