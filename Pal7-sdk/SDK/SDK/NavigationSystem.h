...
{ 
	SDK_UNDEFINED(16,813) /* FString */                __um(AreaClassName);                                        // 0x0000   (0x0010)  
...
public:
	...
	unsigned char                                      UnknownData03_5[0xE0];                                      // 0x02B8   (0x00E0)  MISSED
	TArray<FSupportedAreaData>                         SupportedAreas;                                             // 0x0398   (0x0010)  
	unsigned char                                      UnknownData04_6[0x58];                                      // 0x03A8   (0x0058)  MISSED
};
...
{ 
public:
	FNavGraphNode                                      Node;                                                       // 0x01F0   (0x0018)  
	class UNavigationGraphNodeComponent*               NextNodeComponent;                                          // 0x0208   (0x0008)  
	class UNavigationGraphNodeComponent*               PrevNodeComponent;                                          // 0x0210   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(16,814) /* FMulticastInlineDelegate */ __um(PathUpdatedNotifier);                                // 0x0028   (0x0010)  
	TArray<FVector>                                    PathPoints;                                                 // 0x0038   (0x0010)  
	SDK_UNDEFINED(1,815) /* TEnumAsByte<ENavigationOptionFlag> */ __um(RecalculateOnInvalidation);                 // 0x0048   (0x0001)  
	unsigned char                                      UnknownData01_6[0x3F];                                      // 0x0049   (0x003F)  MISSED


	/// Functions
	// Function /Script/NavigationSystem.NavigationPath.IsValid
	// bool IsValid();                                                                                                       // [0x30ea2f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NavigationSystem.NavigationPath.IsStringPulled
	// bool IsStringPulled();                                                                                                // [0xe7fdc0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NavigationSystem.NavigationPath.IsPartial
	// bool IsPartial();                                                                                                     // [0x30ea2c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NavigationSystem.NavigationPath.GetPathLength
	// float GetPathLength();                                                                                                // [0x30e9bd0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NavigationSystem.NavigationPath.GetPathCost
	// float GetPathCost();                                                                                                  // [0x30e9980] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NavigationSystem.NavigationPath.GetDebugString
	// FString GetDebugString();                                                                                             // [0x30e9880] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NavigationSystem.NavigationPath.EnableRecalculationOnInvalidation
	// void EnableRecalculationOnInvalidation(TEnumAsByte<ENavigationOptionFlag> DoRecalculation);                           // [0x30e9460] Final|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationPath.EnableDebugDrawing
	// void EnableDebugDrawing(bool bShouldDrawDebugData, FLinearColor PathColor);                                           // [0x30e9380] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(40,816) /* TWeakObjectPtr<UClass*> */ __um(CrowdManagerClass);                                   // 0x0040   (0x0028)  
	...
	ENavDataGatheringModeConfig                        DataGatheringMode;                                          // 0x006C   (0x0001)  
	...
	unsigned char                                      UnknownData03_4[0x3];                                       // 0x0071   (0x0003)  MISSED
	...
	unsigned char                                      UnknownData05_5[0x10];                                      // 0x00B0   (0x0010)  MISSED
	SDK_UNDEFINED(16,817) /* FMulticastInlineDelegate */ __um(OnNavDataRegisteredEvent);                           // 0x00C0   (0x0010)  
	SDK_UNDEFINED(16,818) /* FMulticastInlineDelegate */ __um(OnNavigationGenerationFinishedDelegate);             // 0x00D0   (0x0010)  
	unsigned char                                      UnknownData06_5[0xDC];                                      // 0x00E0   (0x00DC)  MISSED
	FNavigationSystemRunMode                           OperationMode;                                              // 0x01BC   (0x0001)  
	unsigned char                                      UnknownData07_5[0x357];                                     // 0x01BD   (0x0357)  MISSED
	float                                              DirtyAreasUpdateFreq;                                       // 0x0514   (0x0004)  
	unsigned char                                      UnknownData08_6[0x20];                                      // 0x0518   (0x0020)  MISSED


	/// Functions
	// Function /Script/NavigationSystem.NavigationSystemV1.UnregisterNavigationInvoker
	// void UnregisterNavigationInvoker(class AActor* Invoker);                                                              // [0x30eb570] Final|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.SimpleMoveToLocation
	// void SimpleMoveToLocation(class AController* Controller, FVector& Goal);                                              // [0x30eb4b0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.SimpleMoveToActor
	// void SimpleMoveToActor(class AController* Controller, class AActor* Goal);                                            // [0x30eb400] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.SetMaxSimultaneousTileGenerationJobsCount
	// void SetMaxSimultaneousTileGenerationJobsCount(int32_t MaxNumberOfJobs);                                              // [0x30eb380] Final|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.SetGeometryGatheringMode
	// void SetGeometryGatheringMode(ENavDataGatheringModeConfig NewMode);                                                   // [0x30eb300] Final|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.ResetMaxSimultaneousTileGenerationJobsCount
	// void ResetMaxSimultaneousTileGenerationJobsCount();                                                                   // [0x30eb2e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.RegisterNavigationInvoker
	// void RegisterNavigationInvoker(class AActor* Invoker, float TileGenerationRadius, float TileRemovalRadius);           // [0x30eb1e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.ProjectPointToNavigation
	// FVector ProjectPointToNavigation(class UObject* WorldContextObject, FVector& Point, class ANavigationData* NavData, class UClass* FilterClass, FVector QueryExtent); // [0x30eb010] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.OnNavigationBoundsUpdated
	// void OnNavigationBoundsUpdated(class ANavMeshBoundsVolume* NavVolume);                                                // [0x30eaf90] Final|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.NavigationRaycast
	// bool NavigationRaycast(class UObject* WorldContextObject, FVector& RayStart, FVector& RayEnd, FVector& HitLocation, class UClass* FilterClass, class AController* Querier); // [0x30ead80] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_ReplaceAreaInOctreeData
	// bool K2_ReplaceAreaInOctreeData(class UObject* Object, class UClass* OldArea, class UClass* NewArea);                 // [0x30eac80] Final|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_ProjectPointToNavigation
	// bool K2_ProjectPointToNavigation(class UObject* WorldContextObject, FVector& Point, FVector& ProjectedLocation, class ANavigationData* NavData, class UClass* FilterClass, FVector QueryExtent); // [0x30eaaa0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_GetRandomReachablePointInRadius
	// bool K2_GetRandomReachablePointInRadius(class UObject* WorldContextObject, FVector& Origin, FVector& RandomLocation, float Radius, class ANavigationData* NavData, class UClass* FilterClass); // [0x30ea8a0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_GetRandomPointInNavigableRadiusEx
	// bool K2_GetRandomPointInNavigableRadiusEx(class UObject* WorldContextObject, FVector& Origin, FVector& RandomLocation, float MaxRadius, float MinRadius, FVector& LastLocation, float DeltaDistance, float DeltaAngle, float LastRandomAngle, float& OutLastRandomAngle, class ANavigationData* NavData, class UClass* FilterClass); // [0x30ea520] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_GetRandomPointInNavigableRadius
	// bool K2_GetRandomPointInNavigableRadius(class UObject* WorldContextObject, FVector& Origin, FVector& RandomLocation, float Radius, class ANavigationData* NavData, class UClass* FilterClass); // [0x30ea320] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_GetRandomLocationInNavigableRadius
	// bool K2_GetRandomLocationInNavigableRadius(class UObject* WorldContextObject, FVector& Origin, FVector& RandomLocation, float Radius, class ANavigationData* NavData, class UClass* FilterClass); // [0x30ea320] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.IsNavigationBeingBuiltOrLocked
	// bool IsNavigationBeingBuiltOrLocked(class UObject* WorldContextObject);                                               // [0x30ea240] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.IsNavigationBeingBuilt
	// bool IsNavigationBeingBuilt(class UObject* WorldContextObject);                                                       // [0x30ea1c0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.GetRandomReachablePointInRadius
	// FVector GetRandomReachablePointInRadius(class UObject* WorldContextObject, FVector& Origin, float Radius, class ANavigationData* NavData, class UClass* FilterClass); // [0x30e9ff0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.GetRandomPointInNavigableRadius
	// FVector GetRandomPointInNavigableRadius(class UObject* WorldContextObject, FVector& Origin, float Radius, class ANavigationData* NavData, class UClass* FilterClass); // [0x30e9e20] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.GetPathLength
	// TEnumAsByte<ENavigationQueryResult> GetPathLength(class UObject* WorldContextObject, FVector& PathStart, FVector& PathEnd, float& PathLength, class ANavigationData* NavData, class UClass* FilterClass); // [0x30e9c00] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.GetPathCost
	// TEnumAsByte<ENavigationQueryResult> GetPathCost(class UObject* WorldContextObject, FVector& PathStart, FVector& PathEnd, float& PathCost, class ANavigationData* NavData, class UClass* FilterClass); // [0x30e99b0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.GetNavigationSystem
	// class UNavigationSystemV1* GetNavigationSystem(class UObject* WorldContextObject);                                    // [0x30e9900] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.FindPathToLocationSynchronously
	// class UNavigationPath* FindPathToLocationSynchronously(class UObject* WorldContextObject, FVector& PathStart, FVector& PathEnd, class AActor* PathfindingContext, class UClass* FilterClass); // [0x30e96d0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.FindPathToActorSynchronously
	// class UNavigationPath* FindPathToActorSynchronously(class UObject* WorldContextObject, FVector& PathStart, class AActor* GoalActor, float TetherDistance, class AActor* PathfindingContext, class UClass* FilterClass); // [0x30e94e0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(1,819) /* TEnumAsByte<ENavCostDisplay> */ __um(CostDisplayMode);                                 // 0x02AC   (0x0001)  
...
public:
	...
	TArray<FNavigationLink>                            Links;                                                      // 0x0410   (0x0010)  
};
...
public:
	...
	// void SetNavigationRelevancy(bool bRelevant);                                                                          // [0x30ed4f0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(1,820) /* TEnumAsByte<ENavLinkDirection> */ __um(LinkDirection);                                 // 0x011C   (0x0001)  
	...
	SDK_UNDEFINED(1,821) /* TEnumAsByte<ECollisionChannel> */ __um(BroadcastChannel);                              // 0x0150   (0x0001)  
...
{ 
public:
	unsigned char                                      UnknownData00_1[0x18];                                      // 0x0408   (0x0018)  MISSED
};
...
public:
	...
	// void SetAreaClass(class UClass* NewAreaClass);                                                                        // [0x30ed470] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetAreaClass(class UClass* NewAreaClass);                                                                        // [0x30ed3f0] Final|Native|Public|BlueprintCallable 
};
...
{ 
public:
	bool                                               bDrawTriangleEdges : 1;                                     // 0x0400:0 (0x0001)  
	bool                                               bDrawPolyEdges : 1;                                         // 0x0400:1 (0x0001)  
	bool                                               bDrawFilledPolys : 1;                                       // 0x0400:2 (0x0001)  
	bool                                               bDrawNavMeshEdges : 1;                                      // 0x0400:3 (0x0001)  
	bool                                               bDrawTileBounds : 1;                                        // 0x0400:4 (0x0001)  
	bool                                               bDrawPathCollidingGeometry : 1;                             // 0x0400:5 (0x0001)  
	bool                                               bDrawTileLabels : 1;                                        // 0x0400:6 (0x0001)  
	bool                                               bDrawPolygonLabels : 1;                                     // 0x0400:7 (0x0001)  
	bool                                               bDrawDefaultPolygonCost : 1;                                // 0x0401:0 (0x0001)  
	bool                                               bDrawLabelsOnPathNodes : 1;                                 // 0x0401:1 (0x0001)  
	bool                                               bDrawNavLinks : 1;                                          // 0x0401:2 (0x0001)  
	bool                                               bDrawFailedNavLinks : 1;                                    // 0x0401:3 (0x0001)  
	bool                                               bDrawClusters : 1;                                          // 0x0401:4 (0x0001)  
	bool                                               bDrawOctree : 1;                                            // 0x0401:5 (0x0001)  
	bool                                               bDrawOctreeDetails : 1;                                     // 0x0401:6 (0x0001)  
	bool                                               bDrawMarkedForbiddenPolys : 1;                              // 0x0401:7 (0x0001)  
	bool                                               bDistinctlyDrawTilesBeingBuilt : 1;                         // 0x0402:0 (0x0001)  
	bool                                               bDrawNavMesh : 1;                                           // 0x0402:1 (0x0001)  
	unsigned char                                      UnknownData00_4[0x1];                                       // 0x0403   (0x0001)  MISSED
	float                                              DrawOffset;                                                 // 0x0404   (0x0004)  
	bool                                               bFixedTilePoolSize : 1;                                     // 0x0408:0 (0x0001)  
	unsigned char                                      UnknownData01_4[0x3];                                       // 0x0409   (0x0003)  MISSED
	int32_t                                            TilePoolSize;                                               // 0x040C   (0x0004)  
	float                                              TileSizeUU;                                                 // 0x0410   (0x0004)  
	float                                              CellSize;                                                   // 0x0414   (0x0004)  
	float                                              CellHeight;                                                 // 0x0418   (0x0004)  
	float                                              AgentRadius;                                                // 0x041C   (0x0004)  
	float                                              AgentHeight;                                                // 0x0420   (0x0004)  
	float                                              AgentMaxHeight;                                             // 0x0424   (0x0004)  
	float                                              AgentMaxSlope;                                              // 0x0428   (0x0004)  
	float                                              AgentMaxStepHeight;                                         // 0x042C   (0x0004)  
	float                                              MinRegionArea;                                              // 0x0430   (0x0004)  
	float                                              MergeRegionSize;                                            // 0x0434   (0x0004)  
	float                                              MaxSimplificationError;                                     // 0x0438   (0x0004)  
	int32_t                                            MaxSimultaneousTileGenerationJobsCount;                     // 0x043C   (0x0004)  
	int32_t                                            TileNumberHardLimit;                                        // 0x0440   (0x0004)  
	int32_t                                            PolyRefTileBits;                                            // 0x0444   (0x0004)  
	int32_t                                            PolyRefNavPolyBits;                                         // 0x0448   (0x0004)  
	int32_t                                            PolyRefSaltBits;                                            // 0x044C   (0x0004)  
	FVector                                            NavMeshOriginOffset;                                        // 0x0450   (0x000C)  
	float                                              DefaultDrawDistance;                                        // 0x045C   (0x0004)  
	float                                              DefaultMaxSearchNodes;                                      // 0x0460   (0x0004)  
	float                                              DefaultMaxHierarchicalSearchNodes;                          // 0x0464   (0x0004)  
	SDK_UNDEFINED(1,822) /* TEnumAsByte<ERecastPartitioning> */ __um(RegionPartitioning);                          // 0x0468   (0x0001)  
	SDK_UNDEFINED(1,823) /* TEnumAsByte<ERecastPartitioning> */ __um(LayerPartitioning);                           // 0x0469   (0x0001)  
	unsigned char                                      UnknownData02_5[0x2];                                       // 0x046A   (0x0002)  MISSED
	int32_t                                            RegionChunkSplits;                                          // 0x046C   (0x0004)  
	int32_t                                            LayerChunkSplits;                                           // 0x0470   (0x0004)  
	bool                                               bSortNavigationAreasByCost : 1;                             // 0x0474:0 (0x0001)  
	bool                                               bPerformVoxelFiltering : 1;                                 // 0x0474:1 (0x0001)  
	bool                                               bMarkLowHeightAreas : 1;                                    // 0x0474:2 (0x0001)  
	bool                                               bFilterLowSpanSequences : 1;                                // 0x0474:3 (0x0001)  
	bool                                               bFilterLowSpanFromTileCache : 1;                            // 0x0474:4 (0x0001)  
	bool                                               bDoFullyAsyncNavDataGathering : 1;                          // 0x0474:5 (0x0001)  
	bool                                               bUseBetterOffsetsFromCorners : 1;                           // 0x0474:6 (0x0001)  
	bool                                               bStoreEmptyTileLayers : 1;                                  // 0x0474:7 (0x0001)  
	bool                                               bUseVirtualFilters : 1;                                     // 0x0475:0 (0x0001)  
	bool                                               bAllowNavLinkAsPathEnd : 1;                                 // 0x0475:1 (0x0001)  
	bool                                               bUseVoxelCache : 1;                                         // 0x0475:2 (0x0001)  
	unsigned char                                      UnknownData03_4[0x2];                                       // 0x0476   (0x0002)  MISSED
	float                                              TileSetUpdateInterval;                                      // 0x0478   (0x0004)  
	float                                              HeuristicScale;                                             // 0x047C   (0x0004)  
	float                                              VerticalDeviationFromGroundCompensation;                    // 0x0480   (0x0004)  
	unsigned char                                      UnknownData04_6[0x34];                                      // 0x0484   (0x0034)  MISSED


	/// Functions
	// Function /Script/NavigationSystem.RecastNavMesh.K2_ReplaceAreaInTileBounds
	// bool K2_ReplaceAreaInTileBounds(FBox Bounds, class UClass* OldArea, class UClass* NewArea, bool ReplaceLinks);        // [0x30ed260] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
{ 
	...
	SDK_UNDEFINED(1,824) /* TEnumAsByte<ERecastPartitioning> */ __um(RegionPartitioning);                          // 0x0030   (0x0001)  
	SDK_UNDEFINED(1,825) /* TEnumAsByte<ERecastPartitioning> */ __um(LayerPartitioning);                           // 0x0031   (0x0001)  
	...
	bool                                               bFilterLowSpanSequences : 1;                                // 0x003C:3 (0x0001)  
	bool                                               bFilterLowSpanFromTileCache : 1;                            // 0x003C:4 (0x0001)  
	bool                                               bFixedTilePoolSize : 1;                                     // 0x003C:5 (0x0001)  
