...
{ 
	...
	SDK_UNDEFINED(40,3110) /* TWeakObjectPtr<UClass*> */ __um(SoftClass);                                          // 0x0010   (0x0028)  
	class UObject*                                     Object;                                                     // 0x0038   (0x0008)  
	SDK_UNDEFINED(8,3111) /* TWeakObjectPtr<UMetaData*> */ __um(WeakObject);                                       // 0x0040   (0x0008)  
	SDK_UNDEFINED(40,3112) /* TWeakObjectPtr<UMetaData*> */ __um(SoftObject);                                      // 0x0048   (0x0028)  
...
{ 
	...
	SDK_UNDEFINED(16,3113) /* FString */               __um(String);                                               // 0x0018   (0x0010)  
	SDK_UNDEFINED(24,3114) /* FText */                 __um(Text);                                                 // 0x0028   (0x0018)  
...
{ 
	SDK_UNDEFINED(80,3115) /* TMap<int32_t, FString> */ __um(IntToStr);                                            // 0x0000   (0x0050)  
	SDK_UNDEFINED(80,3116) /* TMap<FString, FString> */ __um(StrToStr);                                            // 0x0050   (0x0050)  
	SDK_UNDEFINED(80,3117) /* TMap<FString, FVector> */ __um(StrToVec);                                            // 0x00A0   (0x0050)  
	SDK_UNDEFINED(80,3118) /* TMap<FString, FStructSerializerBuiltinTestStruct> */ __um(StrToStruct);              // 0x00F0   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(80,3119) /* TSet<FString> */         __um(StrSet);                                               // 0x0000   (0x0050)  
	SDK_UNDEFINED(80,3120) /* TSet<int32_t> */         __um(IntSet);                                               // 0x0050   (0x0050)  
	SDK_UNDEFINED(80,3121) /* TSet<FName> */           __um(NameSet);                                              // 0x00A0   (0x0050)  
	SDK_UNDEFINED(80,3122) /* TSet<FStructSerializerBuiltinTestStruct> */ __um(StructSet);                         // 0x00F0   (0x0050)  
};
