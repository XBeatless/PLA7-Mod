...
{ 
	...
	SDK_UNDEFINED(1,21) /* TEnumAsByte<ESlateColorStylingMode> */ __um(ColorUseRule);                              // 0x0010   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(1,22) /* TEnumAsByte<ESlateBrushDrawType> */ __um(DrawAs);                                       // 0x006C   (0x0001)  
	SDK_UNDEFINED(1,23) /* TEnumAsByte<ESlateBrushTileType> */ __um(Tiling);                                       // 0x006D   (0x0001)  
	SDK_UNDEFINED(1,24) /* TEnumAsByte<ESlateBrushMirrorType> */ __um(Mirroring);                                  // 0x006E   (0x0001)  
	SDK_UNDEFINED(1,25) /* TEnumAsByte<ESlateBrushImageType> */ __um(ImageType);                                   // 0x006F   (0x0001)  
	unsigned char                                      UnknownData00_5[0x10];                                      // 0x0070   (0x0010)  MISSED
...
{ 
	FSlateFontInfo                                     Font;                                                       // 0x0008   (0x0050)  
	FSlateColor                                        ColorAndOpacity;                                            // 0x0058   (0x0028)  
	FSlateBrush                                        BackgroundImageSelected;                                    // 0x0080   (0x0088)  
	FSlateBrush                                        BackgroundImageComposing;                                   // 0x0108   (0x0088)  
	FSlateBrush                                        CaretImage;                                                 // 0x0190   (0x0088)  
};
...
{ 
	...
	FSlateFontInfo                                     Font;                                                       // 0x0238   (0x0050)  
	FSlateColor                                        ForegroundColor;                                            // 0x0288   (0x0028)  
	FSlateColor                                        BackgroundColor;                                            // 0x02B0   (0x0028)  
	FSlateColor                                        ReadOnlyForegroundColor;                                    // 0x02D8   (0x0028)  
	FMargin                                            HScrollBarPadding;                                          // 0x0300   (0x0010)  
	FMargin                                            VScrollBarPadding;                                          // 0x0310   (0x0010)  
	FScrollBarStyle                                    ScrollBarStyle;                                             // 0x0320   (0x04D0)  
};
...
{ 
	...
	FSlateColor                                        SelectedBackgroundColor;                                    // 0x0098   (0x0028)  
	FLinearColor                                       HighlightColor;                                             // 0x00C0   (0x0010)  
	FSlateBrush                                        HighlightShape;                                             // 0x00D0   (0x0088)  
	FSlateBrush                                        StrikeBrush;                                                // 0x0158   (0x0088)  
	FSlateBrush                                        UnderlineBrush;                                             // 0x01E0   (0x0088)  
};
...
struct FFontData
{ 
	SDK_UNDEFINED(16,26) /* FString */                 __um(FontFilename);                                         // 0x0000   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,27) /* FString */                 __um(Cultures);                                             // 0x0028   (0x0010)  
};
...
{ 
	...
	FTextBlockStyle                                    TitleTextStyle;                                             // 0x09E8   (0x0268)  
	FSlateBrush                                        ActiveTitleBrush;                                           // 0x0C50   (0x0088)  
	FSlateBrush                                        InactiveTitleBrush;                                         // 0x0CD8   (0x0088)  
	FSlateBrush                                        FlashTitleBrush;                                            // 0x0D60   (0x0088)  
	FSlateColor                                        BackgroundColor;                                            // 0x0DE8   (0x0028)  
	FSlateBrush                                        OutlineBrush;                                               // 0x0E10   (0x0088)  
	FSlateColor                                        OutlineColor;                                               // 0x0E98   (0x0028)  
	FSlateBrush                                        BorderBrush;                                                // 0x0EC0   (0x0088)  
	FSlateBrush                                        BackgroundBrush;                                            // 0x0F48   (0x0088)  
	FSlateBrush                                        ChildBackgroundBrush;                                       // 0x0FD0   (0x0088)  
};
...
{ 
	FEditableTextBoxStyle                              TextBoxStyle;                                               // 0x0008   (0x07F0)  
	FSlateFontInfo                                     ActiveFontInfo;                                             // 0x07F8   (0x0050)  
	FSlateBrush                                        UpArrowImage;                                               // 0x0848   (0x0088)  
	FSlateBrush                                        DownArrowImage;                                             // 0x08D0   (0x0088)  
	FSlateBrush                                        GlassImage;                                                 // 0x0958   (0x0088)  
	FSlateBrush                                        ClearImage;                                                 // 0x09E0   (0x0088)  
	FMargin                                            ImagePadding;                                               // 0x0A68   (0x0010)  
	bool                                               bLeftAlignButtons;                                          // 0x0A78   (0x0001)  
	unsigned char                                      UnknownData00_6[0x7];                                       // 0x0A79   (0x0007)  MISSED
};
...
/// Size: 0x0A58 (0x000008 - 0x000A60)
struct FInlineEditableTextBlockStyle : FSlateWidgetStyle
{ 
	FEditableTextBoxStyle                              EditableTextBoxStyle;                                       // 0x0008   (0x07F0)  
	FTextBlockStyle                                    TextStyle;                                                  // 0x07F8   (0x0268)  
};

/// Struct /Script/SlateCore.HyperlinkStyle
/// Size: 0x04F0 (0x000008 - 0x0004F8)
struct FHyperlinkStyle : FSlateWidgetStyle
{ 
	FButtonStyle                                       UnderlineStyle;                                             // 0x0008   (0x0278)  
	FTextBlockStyle                                    TextStyle;                                                  // 0x0280   (0x0268)  
	FMargin                                            Padding;                                                    // 0x04E8   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(1,28) /* TEnumAsByte<ESlateCheckBoxType> */ __um(CheckBoxType);                                  // 0x0008   (0x0001)  
